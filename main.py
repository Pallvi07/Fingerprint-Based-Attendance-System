...
# email of teacher
server.login('muneesh1512@gmail.com', 'solsnoqhucatksdd')

# creating .csv file to store the studnet data who enterd the class
...
def send_email(student):
    if (student == "Pallvi"):
        server.sendmail('muneesh1512@gmail.com',
...
# call the function to enroll the fingerprints
# enroll_finger()
make_attendance()